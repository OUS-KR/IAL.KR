...
- `IAL.KR/u/{사용자 아이디}` 주소 기반의 사용자 등록
  - 사용자 예제: [IAL.KR/u/ial](https://ial.kr/u/ial) ([IAL.KR/@ial](https://ial.kr/@ial))
...
- `IAL.KR/u/{사용자 아이디}/{단축 경로}` 형태의 단축주소 생성
  - 사용자 단축주소 예제: [IAL.KR/u/ial/links/ial-kr](https://ial.kr/u/ial/links/ial-kr) ([IAL.KR/@ial/links/ial-kr](https://ial.kr/@ial/links/ial-kr))
...
- `IAL.KR/u/{사용자 아이디}/{글 경로}` 형태의 글 작성
  - 사용자 글 예제: [IAL.KR/u/ial/articles/example](https://ial.kr/u/ial/articles/example) ([IAL.KR/@ial/articles/example](https://ial.kr/@ial/articles/example))
